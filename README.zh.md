# Secret Redactor Pipe — 敏感信息脱敏管道

> [English README](README.md)

`github.com/nuln/agent-pipe-redactor` — 敏感信息脱敏管道插件，适用于 [nuln/agent-core](https://github.com/nuln/agent-core)。
...
|------|----|
| **插件类型** | `pipe` (管道) |
| **模块名** | `github.com/nuln/agent-pipe-redactor` |
| **核心依赖** | *(仅标准库)* |
